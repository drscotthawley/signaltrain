...
* [ ]  Better visualization of weights & data, e.g. via [tensorboardX](https://github.com/lanpa/tensorboard-pytorch), [visdom](https://github.com/facebookresearch/visdom) or [Crayon](https://github.com/torrvision/crayon)
